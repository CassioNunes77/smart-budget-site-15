...
import { Edit, Trash2, TrendingUp, TrendingDown, Filter, CheckCircle, XCircle, Clock, Upload } from 'lucide-react';
...
const TransactionsList: React.FC<TransactionsListProps> = ({ 
  ...
  const getCategoryData = (categoryName: string) => {
    ...
    return {
      icon: 'Tag',
      color: '#64748b',
      className: 'bg-slate-100 text-slate-800 dark:bg-slate-800/30 dark:text-slate-300 text-xs flex items-center gap-1'
    };
  };
              ...
              <div className="flex items-center space-x-4 flex-1">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                    ...
                    >
                      <CategoryIcon iconName={categoryData.icon} className="w-3 h-3" />
